...
public class ListEntry {
    ...
    public ListEntry() {
        this(-1, new Timestamp(System.currentTimeMillis()), -1, new Timestamp(System.currentTimeMillis()), -1, -1);
    }
    
    public ListEntry(int idRegister, Timestamp leftTimestamp, int leftRR, Timestamp rightTimestamp, int rightRR, int id) {
    ...
    public String toString( ){
        String value = getIdRegister() +", " + getLeftTimestamp() + ", " + getLeftRR() + ", " + getRightTimestamp() + ", " + getRightRR() + ": " + id;
        return value;
